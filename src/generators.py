...
def filter_by_currency(transactions: list[dict], value: str) -> Iterator[dict]:
    """Функция принимает список словарей и возвращает итератор, который поочередно выдает транзакции,
    в заданной валюте"""
...
# form = transaction_descriptions([], "USD")
print(next(form))
